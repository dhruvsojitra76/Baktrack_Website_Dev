  ...
  return (
    <>
      <footer className="bg-gray-900 text-gray-300 px-6 py-12" id="contact">
        <div className="max-w-6xl justify-center mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://www.linkedin.com/company/baktrack/" target="_blank" className="hover:text-white transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="/TermsAndConditions" className="hover:text-white transition-colors">Terms & Conditions</a></li>
